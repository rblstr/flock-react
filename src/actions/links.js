...
export const LINKS_REFRESHING = 'LINKS_REFRESHING'
...
export const refreshLinks = (subreddits, sortType='hot', t='all') => {
    return dispatch => {
        if (!subreddits || !subreddits.length) {
            dispatch(recieveLinks([]))
            return
...
const linksRefreshing = () => {
    return {
        type: LINKS_REFRESHING
    }
}
